...
import {LocalOffer as Budge} from '@mui/icons-material';
...
const StyledBadge = styled(Budge)`
margin-right: 10px;
color: #00CC00;
font-size: 15px;
`
    ...
    return (
        <>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge />No Cost EMI on Bajaj Finserv EMI Card on Card value above ₹2999</Typography>
            </SmallText>
            <Table>
                <TableBody>
                    <ColumnText>
